...
fun MonthEachCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = transactionLogMonth.monthDesc,
                modifier = Modifier
                    .clickable {
            ...
            AnimatedVisibility(
                ...
                Column(
                    ...
                    transactionLogMonth.transactionLogList.forEach { transactionLog ->
                        EachCard(transactionLog = transactionLog)
                    }
                }
            }
        }
